...
internal class KafkaConnection : IKafkaConnection
{
    ...
    public IConsumer<Guid, T>? Consumer<T>()
        where T : IntegrationEvent
    {
        ...
        return new ConsumerBuilder<Guid, T>(_kafkaConfig.ConsumerConfig).Build();
    }

    public IProducer<Guid, T>? Producer<T>()
                where T : IntegrationEvent
    {
        ...
        return new ProducerBuilder<Guid, T>(_kafkaConfig.ProducerConfig).Build();
    }
}
